...
WAGON_STATUSES = [
    EXPECTED, ARRIVED, GROSS_WEIGHED, LAB_PENDING, UNLOADING_ALLOWED,
    SILO_ASSIGNED, UNLOADING, UNLOADING_COMPLETED, TARE_WEIGHED, INVENTORIED,
    EXIT_ALLOWED, EXITED, COMPLETED,
    UNPLANNED, WAITING_FOR_APPROVAL, REJECTED, QUARANTINE,
    INSUFFICIENT_CAPACITY, WEIGHT_DISCREPANCY, REWEIGHING_REQUIRED,
    BLOCKED, RETURN_TO_SUPPLIER, CANCELLED,
]
...
ON_SITE_STATUSES = {
    ARRIVED, GROSS_WEIGHED, LAB_PENDING, UNLOADING_ALLOWED, SILO_ASSIGNED,
    UNLOADING, UNLOADING_COMPLETED, TARE_WEIGHED, INVENTORIED, EXIT_ALLOWED,
    WAITING_FOR_APPROVAL, REJECTED, QUARANTINE, INSUFFICIENT_CAPACITY,
    WEIGHT_DISCREPANCY, REWEIGHING_REQUIRED, BLOCKED,
}
...
VALID_TRANSITIONS: dict[str, set[str]] = {
    ...
    ARRIVED: {GROSS_WEIGHED, BLOCKED, CANCELLED, RETURN_TO_SUPPLIER},
    ...
    WEIGHT_DISCREPANCY: {TARE_WEIGHED, REWEIGHING_REQUIRED},
    REWEIGHING_REQUIRED: {TARE_WEIGHED},
    INVENTORIED: {EXIT_ALLOWED},
    EXIT_ALLOWED: {EXITED, BLOCKED},
    EXITED: {COMPLETED},
    BLOCKED: {
        ARRIVED, LAB_PENDING, UNLOADING_ALLOWED, SILO_ASSIGNED,
        EXIT_ALLOWED, CANCELLED,
    },
}
