    ...
    def _decoder_loop(self) -> None:
        ...
        while not self._stop.is_set():
            ...
            with self._lock:
                ...
                submit_inference = (
                    captured_at - self._last_inference_submit
...
class DroppingFrameQueue:
    ...
    def __init__(self, per_camera_size: int):
        ...
        self._items: deque[
            tuple[CameraProcessor, Any, float, int, int]
        ] = deque()
        self._condition = threading.Condition()

    def put_latest(
        self, item: tuple[CameraProcessor, Any, float, int, int]
