...
export const PERMISSION_PRESETS: PermissionPreset[] = [
  {
    key: "cashier",
    label: "Кассир",
    codes: ["payments.view", "payments.create", "payments.confirm", "reports.view", "clients.view", "orders.view"],
  },
  {
    key: "accountant",
    label: "Бухгалтер",
    codes: ["reports.view", "reports.export", "payments.view", "payments.confirm", "clients.view", "orders.view"],
  },
  {
    key: "manager",
    label: "Менеджер",
