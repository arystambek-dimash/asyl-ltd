...
function buildSteps(me: Me): TourStep[] {
  ...
  if (can(me, "warehouse.view") || can(me, "grain.view"))
    steps.push({
      ...
      title: "Завод",
      text: "Схема участков, склад готовой продукции и силосный парк собраны внутри завода. На складе доступны приёмка и списание с предпросмотром «сейчас → станет».",
    });
  steps.push({
    target: "profile",
    title: "Профиль",
